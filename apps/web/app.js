(() => {
  ...
  const I18N = {
    en: {
      ...
      'intro.headline': 'Hi — drop a document and I\'ll edit it for you.',
      'intro.cta': 'Try a sample prompt:',
      'preset.rename': 'Rename a term globally',
      'preset.style': 'Apply a formatting spec',
      'preset.translate': 'Translate to English',
      'preset.rename.value': 'Replace every \'AutoPaper\' with \'PaperAuto\' across the document.',
      'preset.style.value': 'Make all heading text 14pt bold; body text 11pt with 0.5 line spacing after each paragraph.',
      'preset.translate.value': 'Translate every paragraph from Chinese to English while keeping the original headings, lists, and tables intact.',
      'footer.disclaimer': 'Generated by DeepSeek · review before sharing',
    ...
    zh: {
      ...
      'dropzone.add': '上传文档',
      'a11y.skip': '跳到主要内容',
      'intro.headline': '你好 —— 把文档拖进来，我帮你改。',
      'intro.cta': '试一条示例：',
      'preset.rename': '全局改写关键词',
      'preset.style': '套用格式说明书',
      'preset.translate': '翻译为英文',
      'preset.rename.value': '把全文出现的"AutoPaper"全部改成"PaperAuto"。',
      'preset.style.value': '所有标题用 14pt 加粗；正文 11pt，每段段后 0.5 行行距。',
      'preset.translate.value': '把每一段从中文翻译为英文，保留原有的标题、列表和表格结构。',
      'footer.disclaimer': '由 DeepSeek 生成 · 请审阅后再使用',
      'run.label': '发送并执行',
      'run.processing': '处理中',
